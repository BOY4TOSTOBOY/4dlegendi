...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text_like', models.TextField(blank=True, default='', null=True, verbose_name='Что понравилось')),
                ('text_better', models.TextField(blank=True, default='', null=True, verbose_name='Что могло быть лучше')),
                ...
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='feedback', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
